...
class UKF {
private:
    // Generate sigma points based on state vector, covariance matrix, lambda and dimension
    ...
    MatrixXd SigmaPointPrediction(MatrixXd Xsig, double delta_t, int n_x, int n_sig, double nu_acc, double nu_yawdd);
