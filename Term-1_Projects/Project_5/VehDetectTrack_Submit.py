...
plt.figure(figsize=(15,15))
plt.subplot(151)
plt.imshow(visualInput(notcars[0]))
plt.subplot(152)
plt.imshow(visualInput(notcars[10]))
plt.subplot(153)
plt.imshow(visualInput(notcars[20]))
plt.subplot(154)
plt.imshow(visualInput(notcars[30]))
plt.subplot(155)
plt.imshow(visualInput(notcars[40]))
